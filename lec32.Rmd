...
\pause Here's a case where the null and alternatives are actually self-evident:
\begin{align*}
H_0 &: \mu_D = 0\\
H_1 &: \mu_D \ne 0
\end{align*}
...
\begin{align*}
P(\hat p < `r 0.1-p_hat`) + P(\hat p > `r p_hat`) &= P\left(Z < \frac{`r 0.1-p_hat` - `r p`}{\sqrt{\frac{`r p`(1-`r p`)}{`r n`}}}\right) + P\left(Z > \frac{`r p_hat` - `r p`}{\sqrt{\frac{`r p`(1-`r p`)}{`r n`}}}\right)\\
